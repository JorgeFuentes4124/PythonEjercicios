...
contribucion_parciales = parciales * 0.3
contribucion_practicos = practicos * 0.2
contribucion_integrador = integrador * 0.5

# Calcular la calificación final sumando las contribuciones de los tres aspectos
calificacion_final = contribucion_parciales + contribucion_practicos + contribucion_integrador
